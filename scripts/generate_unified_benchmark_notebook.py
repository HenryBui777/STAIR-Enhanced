...
cell7_source = [
    ...
    "---\n",
    "Chạy thực nghiệm chuyên sâu trên tập Sports:\n",
    "- **`sports_dcd_gated_dim256`**: DCD-Gated ở không gian 256 chiều (phương pháp lập kỷ lục SOTA).\n",
    "*(Mốc tham chiếu Paper Table 2: Baseline 64D đạt Recall@10=0.0743, Recall@20=0.1117, NDCG@10=0.0407, NDCG@20=0.0503)*."
]

cell8_source = [
    "# Cell 8: Huấn luyện Amazon Sports (Chỉ chạy DUY NHẤT DCD-Gated 256D)\n",
    "DATA_ROOT = '/kaggle/data'\n",
    ...
    "\n",
    "# [CẤU HÌNH KIỂM THỬ]: Chỉ chạy duy nhất DCD-Gated 256D để kiểm tra kết quả chuẩn SOTA hôm qua\n",
    "RUN_SPORTS_64_GATED  = False # Tạm khóa\n",
    "RUN_SPORTS_256_BASE  = False # Tạm khóa\n",
    "RUN_SPORTS_256_GATED = True  # BẬT DUY NHẤT DCD-GATED 256D\n",
    "\n",
    ...
    "#                        epochs=500, embedding_dim=256)\n",
    "\n",
    "# 3. Sports DCD-Gated 256D (DUY NHẤT ĐƯỢC CHẠY)\n",
