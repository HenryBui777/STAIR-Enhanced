...
cell3_source = [
    ...
    "            has_vram = True\n",
    "    if not has_vram:\n",
    "        ax_vram.text(0.5, 0.5, 'VRAM Profile Active\\n(Tracking Pure Tensor Allocation)', ha='center', va='center', transform=ax_vram.transAxes, color='gray')\n",
    "    ax_vram.set_title('(d) Model Tensor VRAM (Paper Standard)', fontweight='bold', fontsize=11)\n",
    "    ax_vram.set_xlabel('Time (s)'); ax_vram.set_ylabel('Tensor Allocation (MB)'); ax_vram.grid(True, ls='--', alpha=0.3)\n",
    ...
    "    table = PrettyTable()\n",
    "    table.field_names = ['Tập dữ liệu', 'Phương pháp', 'Số chiều', 'Time/Epoch', 'GPU VRAM', 'Recall@10', 'Recall@20', 'NDCG@10', 'NDCG@20', 'Δ vs Base 64D', 'Δ vs Base 256D']\n",
    "    table.align = 'l'\n",
    "    base_256_n20 = None\n",
    ...
    "            table.add_row([dname, f\"{method_name}{ep_tag}\", dim, time_str, vram_str, f\"{r10:.4f}\", f\"{r20:.4f}\", f\"{n10:.4f}\", f\"{n20:.4f}\", d_64_str, d_256_str])\n",
    "            rows.append({'Dataset': dname, 'Method': method_name, 'Epoch': ep_found, 'Dimension': dim, 'Time_per_Epoch_s': f\"{time_s:.2f}\" if time_s else '-', 'GPU_Memory_MB': f\"{vram_mb:.0f}\" if vram_mb else '-', 'Recall@10': r10, 'Recall@20': r20, 'NDCG@10': n10, 'NDCG@20': n20, 'Delta_vs_Base64D': d_64_str, 'Delta_vs_Base256D': d_256_str})\n",
    "        else:\n",
...
# Cell 5: Code — Execute Amazon Baby
cell5_source = [
...
# Cell 8: Code — Execute Amazon Sports
cell8_source = [
...
cell17_source = [
    ...
    "            ])\n",
    "            csv_rows.append({\n",
    "                'Dataset': dname, 'Method': method_name, 'Epoch': ep_found, 'Dimension': dim,\n",
