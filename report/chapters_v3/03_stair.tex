...
% ==============================================================================
% SƠ ĐỒ KIẾN TRÚC TIKZ (ĐÃ FIX ROUTING VÀ ÔM TRỌN KHUNG NỀN)
% ==============================================================================
\begin{figure}[H]
\centering
\begin{tikzpicture}[
    ...
    % Vùng nền bên trái & phải (độ cao mở rộng chuẩn xác để chứa trọn vẹn khối bên trong)
    ...
    % Nhánh phải: Safe Spectral Boost
    \node[noisebox, anchor=north] (noise) at (4.1, -0.6) {
        \textbf{Offline Precomputed Graph Denoising}\\[3pt]
        $q_{\text{modal}}$: Thresholded GeoMean\\
    ...
    % Đường dẫn mũi tên vuông góc, đối xứng chuẩn xác, không đâm xuyên
    \draw[arr] (fscout.south) |- ([yshift=0.4cm]totalloss.north) -| ([xshift=-3.5cm]totalloss.north);
    \draw[arr] (anscore.south) |- ([yshift=0.4cm]totalloss.north) -| ([xshift=3.5cm]totalloss.north);
...
% ==============================================================================
% BẢNG THỰC NGHIỆM CHUẨN LONGTABLE / BOOKTABS
% ==============================================================================
\begingroup
\footnotesize
\setlength{\tabcolsep}{4pt}
