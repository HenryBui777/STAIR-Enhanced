...
\begin{tikzpicture}[
    ...
    \node[finalbox, anchor=north] (totalloss) at (0.0, -8.6) {\textbf{Hàm mục tiêu tối ưu đồng thời toàn hệ thống}\\[4pt]$\mathcal{L}_{\text{total}} = \mathcal{L}_{\text{BPR}}(H^{(L)}) + \lambda_{\text{nlgcl}} \mathcal{L}_{\text{NE-NLGCL+}}$};

    \draw[arr] (fscout.south) -- ++(0, -1.0) -| ([xshift=-4.5cm]totalloss.north);
    \draw[arr] (anscore.south) -- ++(0, -2.4) -| ([xshift=4.5cm]totalloss.north);
...
% ==============================================================================
% BẢNG DỮ LIỆU THỰC NGHIỆM CHUẨN BOOKTABS / LONGTABLE
% ==============================================================================
\begingroup
\footnotesize
