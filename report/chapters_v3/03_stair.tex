...
Về hiệu năng phần cứng, kiến trúc STAIR-NE-NLGCL+ (v3) đạt độ tối ưu vượt trội trong toàn bộ quy trình nghiên cứu. Việc loại bỏ hoàn toàn lớp MLP projection head và áp dụng cơ chế Dynamic Slicing giúp mức tiêu thụ VRAM đỉnh trên tập Electronics rút xuống chỉ còn 1420\,MB. Mức tiêu thụ này giảm tới 29.4\% so với mốc STAIR Baseline thực nghiệm đo đạc trên cùng GPU Tesla T4 (2011.2\,MB, và giảm 18.3\% so với mốc 1738\,MB công bố trong bài báo gốc), đồng thời tiết kiệm 32.4\% ($\approx 33\%$) bộ nhớ so với phiên bản tương phản tiền nhiệm ở Giai đoạn~2 (STAIR-NE-NLGCL GĐ2 với 2100\,MB). Trên hai tập còn lại, VRAM đỉnh cũng duy trì ở mức rất thấp (609.2\,MB trên Baby và 781.5\,MB trên Sports, đều nhẹ hơn khoảng 20\% so với baseline thực nghiệm), trong khi thời gian huấn luyện mỗi epoch hoàn toàn tương đương baseline. Sự tinh gọn này khẳng định khả năng mở rộng mạnh mẽ của hệ thống trên các hạ tầng máy học thực tế.
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item STAIR-NE-NLGCL+ (v3) đạt hiệu quả bộ nhớ ấn tượng khi giảm 29.4\% VRAM đỉnh so với STAIR Baseline thực nghiệm (chỉ còn 1420\,MB trên Electronics so với 2011.2\,MB của baseline, và giảm 32.4\% so với mức 2100\,MB của bản tiền nhiệm Giai đoạn~2).
